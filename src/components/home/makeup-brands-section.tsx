...
import { makeupBrandLogos } from '@/lib/data';

export function MakeupBrandsSection() {
  const extendedLogos = [...makeupBrandLogos, ...makeupBrandLogos];

  return (
    <section className="py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h3 className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">
          Featuring products from world-renowned brands
        </h3>
